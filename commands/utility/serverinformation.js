...
module.exports = {
    ...
    async execute(interaction) {
        const image = "https://cdn.discordapp.com/attachments/1282058544337653792/1282066130780815390/GVRN_7.png?ex=66de00a1&is=66dcaf21&hm=406071898a5862a41d9a509a11ff7c30b61812f93ed62cc9d43e81c8d89ff3f2&";

        const embed1 = new EmbedBuilder()
            .setTitle('Server Information')
            .setDescription(`> Welcome to GVRN, here you can get information about the server. If you need more information about the server you may go to <#1282044979262263366>`)
            .setColor(`#f3eeee`);
