    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(` Thank you for joining the Greenville Roleplay Network session. We hope you enjoyed it!

                **__Session Details:__**
                Host: **<@${interaction.user.id}>**
                Start Time: **${startTime}**
                End Time: **${endTime}**`)
                .setImage("https://cdn.discordapp.com/attachments/1282058544337653792/1282066130462183485/GVRN_6.png?ex=66de00a1&is=66dcaf21&hm=db88435660d49630c534f492d38e96dd8fb2bee2b02e10d18305330243d8bbd8&")
                    .setColor('#f6f5f5')
                    .setFooter({
